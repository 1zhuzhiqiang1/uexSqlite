...
class SQLiteAndroidDatabase {
    ...
    protected SQLitePlugin sqLitePlugin;

    public SQLiteAndroidDatabase(SQLitePlugin sqLitePlugin) {
     ...
     */
    void executeSqlBatch(String[] queryarr, JSONArray[] jsonparamsArr, final int funcCallback) {
